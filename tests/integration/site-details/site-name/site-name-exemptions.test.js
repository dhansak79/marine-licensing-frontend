...
describe('Site name page', () => {
  ...
  const setupMock = (siteDetails = [{}]) => {
    mockExemption({ ...mockExemptionData, siteDetails })
  }
  ...
  sharedSiteNameTests({
    ...
    cancelLinkHref: '/exemption/task-list?cancel=site-details',
    backLinkHref: '/exemption/does-your-project-involve-more-than-one-site'
  })
